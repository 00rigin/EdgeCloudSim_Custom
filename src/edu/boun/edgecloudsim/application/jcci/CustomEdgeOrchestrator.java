...
//			List<EdgeVM> localVM = SimManager.getInstance().getEdgeServerManager().getVmList(sourcePointLocation.getServingWlanId()); // vm list : ����� 1��
			
			double localUsage = SimManager.getInstance().getEdgeServerManager().getEdgeUtilization(sourcePointLocation.getServingWlanId()); // ���� ���������� ��ƿ�������̼�
			NetworkModel networkModel = SimManager.getInstance().getNetworkModel();	
			result = SimUtils.getRandomNumber(0, 9); // ���� ��� �ʱ�ȭ (���� �������� ���̵�)
