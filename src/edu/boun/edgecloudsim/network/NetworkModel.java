...
public abstract class NetworkModel {
	 ...
	 */
	public abstract double getUploadDelay(int sourceDeviceId, int destDeviceId, Task_Custom task);

	/**
	 * calculates the download delay from source to destination device
	 */
	public abstract double getDownloadDelay(int sourceDeviceId, int destDeviceId, Task_Custom task);
